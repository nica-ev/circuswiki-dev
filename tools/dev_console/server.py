...
from dev_console import routes_graph, routes_navigation, routes_obsidian, routes_translation  # noqa: E402
...
class DevConsoleHandler(SimpleHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        for routes in (routes_translation, routes_navigation, routes_graph, routes_obsidian):
