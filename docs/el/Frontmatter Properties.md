...
publish: true
tags: 
title: Ιδιότητες Frontmatter
description: Πώς χρησιμοποιούμε το Frontmatter στα αρχεία Markdown
authors:
  - Marc Bielert
...
translation_updated: 2026-06-07T13:39:56+00:00
...
---
Χρησιμοποιούμε την ακόλουθη μορφή Frontmatter

| Ιδιότητα | Τύπος Δεδομένων | Προεπιλογή | Επεξήγηση
