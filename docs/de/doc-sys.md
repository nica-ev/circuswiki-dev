...
Besonders durch die Nutzung von [Obsidian](Obsidian%20Setup.md) als Texteditor hat dieses Setup gewaltige Vorteile:
...
- einfaches managen von Meta-Daten (sogenanntes [Frontmatter](Frontmatter%20Properties.md) oder YAML)
...
In einfachen Textdateien wird der Inhalt erstellt - dies kann in jedem beliebigen Texteditor erfolgen welcher das [Markdown Format](Markdown.md) beherrscht. 
